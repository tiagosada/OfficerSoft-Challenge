...
namespace Tests.Domain.Users
{
    public class UsersServiceTest
    {
        ...
        {
            var username = "Escola";
            _usersRepository.Setup(x => x.Get(It.IsAny<Func<User,bool>>())).Returns(new User(username, "password"));
            
            var resp = _usersService.Create(username, "senha123");
        ...
        public void should_create_user_when_is_valid()
        {
            ...
            var resp = _usersService.Create("Escola", password);
